...
# 15 "mcc_generated_files/../modbus_slave.h"
...
# 15 "mcc_generated_files/../modbus_slave.h" 2
...
# 19 "mcc_generated_files/../modbus_slave.h" 2
...
volatile uint8_t eusartTxBuffer[64];
...
void EUSART_Initialize(void)
{
    ...
    PIE1bits.RCIE = 0;
    EUSART_SetRxInterruptHandler(mbus_rx_handler);
    PIE1bits.TXIE = 0;
    EUSART_SetTxInterruptHandler(mbus_tx_handler);
